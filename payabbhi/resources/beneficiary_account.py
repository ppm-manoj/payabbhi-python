...
class BeneficiaryAccount(APIResource):
    ...
    def all(self, data=None, **kwargs):
        ...
        Args:
            data : Dictionary having keys using which BeneficiaryAccount list will be filtered
                count:              Count of BeneficiaryAccounts to be retrieved
                skip:               Number of BeneficiaryAccounts to be skipped
                to:                 BeneficiaryAccount list till this timestamp will be retrieved
                from:               BeneficiaryAccount list from this timestamp will be retrieved
        Returns:
