...
class Payment_Link(APIResource):

    def __init__(self, client=None):
        super(Payment_Link, self).__init__(client)

    def all(self, data=None, **kwargs):
        """"
        Get all Payment_Links
        Args:
            data : Dictionary having keys using which Payment_Link list will be filtered
    ...
    def create(self, data, **kwargs):
        """"
        Create Payment_Link from given data
        Args:
            data : Dictionary having keys using which Payment_Link has to be created
