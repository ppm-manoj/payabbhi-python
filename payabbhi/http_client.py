...
class HTTPClient(object):
    ...
    def convert_to_object(self, resp, client):
        types = {
            ...
            # 'beneficiaryaccount': payabbhi.resources.BeneficiaryAccount,
            'beneficiary_account': payabbhi.resources.BeneficiaryAccount,
            'payment_link': payabbhi.resources.Payment_Link,
            'virtual_account': payabbhi.resources.Virtual_Account,
